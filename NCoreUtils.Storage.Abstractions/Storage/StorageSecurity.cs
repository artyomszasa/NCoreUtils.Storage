...
namespace NCoreUtils.Storage
{
    public sealed class StorageSecurity : IStorageSecurity, IEquatable<IStorageSecurity>
    {
        ...
        private readonly ImmutableDictionary<StorageActor, StoragePermissions> _permissions;
        ...
        IEnumerator<KeyValuePair<StorageActor, StoragePermissions>> IEnumerable<KeyValuePair<StorageActor, StoragePermissions>>.GetEnumerator()
            => _permissions.GetEnumerator();
        ...
        public StoragePermissions GetPermissions(StorageActor actor)
            => _permissions.TryGetValue(actor, out var value) ? value : StoragePermissions.None;
